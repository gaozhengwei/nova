...
class _TestInstancePCIRequests(object):
    ...
    def test_get_by_instance_uuid(self, mock_get):
        ...
        requests = ins_pci_req_obj.InstancePCIRequests.get_by_instance_uuid(
    ...
    def test_get_by_instance_current(self, mock_get):
        instance = instance_obj.Instance(uuid='fake-uuid',
                                    system_metadata={})
        ins_pci_req_obj.InstancePCIRequests.get_by_instance(self.context,
                                                    instance)
    ...
    def test_save(self, mock_update):
        requests = ins_pci_req_obj.InstancePCIRequests(
            ...
            instance_uuid=FAKE_UUID,
            requests=[ins_pci_req_obj.InstancePCIRequest(
                count=1,
    ...
    def test_save_and_reload(self, mock_get, mock_update):
        ...
        requests = ins_pci_req_obj.InstancePCIRequests(
            ...
            requests=[ins_pci_req_obj.InstancePCIRequest(
                ...
                spec=[{'foo': 'bar'}])])
        requests.save()
        _requests = ins_pci_req_obj.InstancePCIRequests.get_by_instance_uuid(
            self.context, FAKE_UUID)
    ...
    def test_new_compatibility(self):
        request = ins_pci_req_obj.InstancePCIRequest(is_new=False)
    ...
    def test_backport_1_0(self):
        ...
        backported = ins_pci_req_obj.InstancePCIRequests.obj_from_primitive(
            primitive)
